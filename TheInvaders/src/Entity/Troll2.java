...
public class Troll2 extends Entity{
    ...
    public Troll2(int x, int y, int width, int height, boolean solid, Id id, Handler handler,
    ...
    public void image_health() throws IOException {
        BufferedImage image= ImageIO.read(getClass().getResourceAsStream("/health.png"));

        health1.health[3]=image.getSubimage(5*630,0,630,150);
    ...
    public void draw(Graphics g) {
        ...
        if(isDeath()) {
            ...
            g.drawImage(EditImage.mirror(Game.troll2[frame-10].getBufferedImage()), getX(), getY(), width, height, null);
        }
        else if(attack) {
            g.drawImage(EditImage.mirror(Game.troll2[frame-20].getBufferedImage()), getX(), getY(), width, height, null);
        }
        else if(right==true)
            g.drawImage(Game.troll2[frame].getBufferedImage(), getX(), getY(), width, height, null);
        else
            g.drawImage(EditImage.mirror(Game.troll2[frame].getBufferedImage()), getX(), getY(), width, height, null);
