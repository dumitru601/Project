...
public class Troll3 extends Entity {
    ...
    public Troll3(int x, int y, int width, int height, boolean solid, Id id, Handler handler,
    ...
    public void draw(Graphics g) {
        ...
        if(isDeath()) {
            ...
            g.drawImage(EditImage.mirror(Game.troll3[frame-10].getBufferedImage()), getX(), getY(), width, height, null);
        }
        else if(attack) {
            g.drawImage(EditImage.mirror(Game.troll3[frame-20].getBufferedImage()), getX(), getY(), width, height, null);
        }
        else if(right==true)
            g.drawImage(Game.troll3[frame].getBufferedImage(), getX(), getY(), width, height, null);
        else
            g.drawImage(EditImage.mirror(Game.troll3[frame].getBufferedImage()), getX(), getY(), width, height, null);
    }
